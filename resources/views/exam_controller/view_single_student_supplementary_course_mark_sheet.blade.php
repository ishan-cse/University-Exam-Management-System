  ...
  <div class="card-body">
    <blockquote class="blockquote mb-0">
     @if($faculty_final_submit_status==1)
      ...
      <form method="POST" action="{{url('exam_controller/update_single_student_supplementary_course_mark_sheet')}}" enctype="multipart/form-data">
          @csrf
        ...
        <input type="hidden" class="form-control" value="{{$single_student_mark_sheet->seventy_percentage_marks}}" name="old_seventy_percentage_marks">
