...
<div class="card">
  ...
  <div class="card-body">
    <blockquote class="blockquote mb-0">
      ...
      <form method="post" action="{{ url('/exam_controller/view_repeat_retake_assign_courses/only_select_trimester_process') }}" enctype="multipart/form-data">
          @csrf
        ...
        <table class="table table-bordered">
          ...
          <td>{{$faculty_name}}</td>
            <td>
              ...
              <a type="button" class="btn btn-primary text-white" href="{{url('exam_controller/view_repeat_retake_assigned_course_marks_sheet/'.$enc_faculty_assign_id)}}">Mark Sheet</a>
