      ...
      <form method="post" action="{{ url('/exam_controller/view_supplementary_assign_courses/only_select_trimester_process') }}" enctype="multipart/form-data">
        ...
        <table class="table table-bordered">
          ...
          <td>
              ...
              <a type="button" class="btn btn-primary text-white" href="{{url('exam_controller/view_supplementary_assigned_course_marks_sheet/'.$enc_faculty_assign_id)}}">Mark Sheet</a>
