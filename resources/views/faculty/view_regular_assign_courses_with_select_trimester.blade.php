...
<div class="card">
  ...
  <div class="card-body">
    <blockquote class="blockquote mb-0">
      ...
      <form method="post" action="{{ url('/faculty/view_regular_assign_courses/only_select_trimester_process') }}" enctype="multipart/form-data">
          @csrf
        ...
        <table class="table table-bordered">
          ...
          <tr>
            ...
            <td>
              ...
              <a type="button" class="btn btn-primary text-white" href="{{url('faculty/view_regular_assigned_course_marks_sheet/'.$enc_batch_course_list_id.'/'.$enc_batch_id.'/'.$enc_trimester_id)}}">Mark Sheet</a>
            </td>
          </tr>
          @endif
