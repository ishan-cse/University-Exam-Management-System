...
<div class="card">
  <div class="card-header">
    <b> Asigned Supplementary Courses </b>
  </div>
  <div class="card-body">
    <blockquote class="blockquote mb-0">


      <form method="post" action="{{ url('/faculty/view_supplementary_assign_courses/only_select_trimester_process') }}" enctype="multipart/form-data">
          @csrf
        ...
        <table class="table table-bordered">
          ...
          <tr>
            ...
            <td>
              ...
              <a type="button" class="btn btn-primary text-white" href="{{url('faculty/view_supplementary_assigned_course_marks_sheet/'.$enc_faculty_assign_id)}}">Mark Sheet</a>
