...
<div class="card">
  <div class="card-header">
    <b> Assign Single Course with Batch : Step 1 </b>
  </div>
  <div class="card-body">
    <blockquote class="blockquote mb-0">


      <form method="post" action="{{ url('/course_coordinator/assign/single_course_with_batch/first_step_process') }}" enctype="multipart/form-data">
          @csrf
