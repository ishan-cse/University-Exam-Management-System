...
<div class="card">
  ...
  <div class="card-body">
    <blockquote class="blockquote mb-0">
      ...
      <form method="post" action="{{ url('/course_coordinator/view_supplementary_assign_courses/only_select_trimester_process') }}" enctype="multipart/form-data">
          @csrf
        ...
        <table class="table table-bordered">
          ...
          <tr>
            ...
            <td>
              ...
              <a class="btn btn-info btn_for_custom" href="{{url('course_coordinator/assign_faculty_to_supplementary_course/'.$enc_trimester_id.'/'.$enc_faculty_assign_id)}}">Assign Faculty</a>
              @if($assigned_course->faculty_finally_assign_status==0)
              <a class="btn btn-danger text-white btn_for_custom" data-toggle="modal" data-target="#dept_exampleModalLong1{{$k}}">Finally Assign</a>
              @endif
              @endif
            </td>
          </tr>
          ...
          <div class="modal fade" id="dept_exampleModalLong1{{$k}}" tabindex="-1" role="dialog" aria-labelledby="dept_exampleModalLongTitle" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <center>
                  <a class="btn btn-success" href="{{url('course_coordinator/assign_faculty_finally_to_supplementary_course/'.$enc_trimester_id.'/'.$enc_faculty_assign_id)}}">Yes</a>
          ...
          <div class="modal fade" id="exampleModalLong2{{$i}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <center>
                  <a class="btn btn-success" href="{{url('course_coordinator/send_to_registrar_for_assigning_faculty_to_supplementary_course/'.$enc_trimester_id.'/'.$enc_faculty_assign_id)}}">Yes</a>
                  <button type="button" class="btn btn-danger" data-dismiss="modal">No</button>
                  </center>
                </div>
              </div>
