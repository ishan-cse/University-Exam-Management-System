...
<div class="card">
  <div class="card-header">
    <b> Assign Repeat/Retake Course to Student </b>
  </div>
  <div class="card-body">
    <blockquote class="blockquote mb-0">


      <form method="post" action="{{ url('/course_coordinator/assign/repeat_retake_course/student/final_step_process') }}" enctype="multipart/form-data">
          @csrf
          ...
          <div class="col-sm-9">
            <select id="exampleFormControlSelect1" class="form-control" name="batch_course_list_id" required>
              ...
              @foreach($student_assigned_courses as $student_assigned_course)
                @if($student_assigned_course->total_marks>=0 && $student_assigned_course->total_marks<=59)
                  @php
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <select id="exampleFormControlSelect1" class="form-control" name="type" required>
