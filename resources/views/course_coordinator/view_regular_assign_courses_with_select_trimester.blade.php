...
<div class="card">
  ...
  <div class="card-body">
    <blockquote class="blockquote mb-0">
      ...
      <form method="post" action="{{ url('/course_coordinator/view_regular_assign_courses/only_select_trimester_process') }}" enctype="multipart/form-data">
          @csrf
        ...
        <table class="table table-bordered">
          ...
          $course_details=DB::table('batch_course_lists')->where('department_id','=',$assigned_course->department_id)->where('batch_id','=',$assigned_course->batch_id)->where('course_version_id','=',$assigned_course->course_version_id)->where('id','=',$assigned_course->batch_course_list_id)->first();
          ...
          $faculty_details=DB::table('faculties')->where('id','=',$assigned_course->faculty_id)->first();
          ...
          <tr>
            ...
            <td>
              ...
              <a class="btn btn-info btn_for_custom" href="{{url('course_coordinator/assign_faculty_to_regular_course/'.$enc_trimester_id.'/'.$enc_faculty_assign_id)}}">Assign Faculty</a>
              @if($assigned_course->faculty_finally_assign_status==0)
              <a class="btn btn-danger text-white btn_for_custom" data-toggle="modal" data-target="#dept_exampleModalLong1{{$i}}"><b>Finally Assign</b></a>
              @endif
              @endif
            </td>
          ...
          <div class="modal fade" id="dept_exampleModalLong1{{$i}}" tabindex="-1" role="dialog" aria-labelledby="dept_exampleModalLongTitle" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <a class="btn btn-success" href="{{url('course_coordinator/assign_faculty_finally_to_regular_course/'.$enc_trimester_id.'/'.$enc_faculty_assign_id)}}">Yes</a>
          ...
          <div class="modal fade" id="exampleModalLong2{{$i}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <center>
                  <a class="btn btn-success" href="{{url('course_coordinator/send_to_registrar_for_assigning_faculty_to_regular_course/'.$enc_trimester_id.'/'.$enc_faculty_assign_id)}}">Yes</a>
                  <button type="button" class="btn btn-danger" data-dismiss="modal">No</button>
                  </center>
                </div>
              </div>
