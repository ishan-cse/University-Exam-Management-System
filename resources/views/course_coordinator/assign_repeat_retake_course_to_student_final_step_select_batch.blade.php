...
<div class="card">
  <div class="card-header">
    <b> Assign Repeat/Retake Course to Student : Select Batch </b>
  </div>
  <div class="card-body">
    <blockquote class="blockquote mb-0">


      <form method="post" action="{{ url('course_coordinator/assign/repeat_retake_course/student/final_step_select_batch_process') }}" enctype="multipart/form-data">
          @csrf
