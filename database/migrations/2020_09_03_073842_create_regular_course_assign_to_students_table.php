...
class CreateRegularCourseAssignToStudentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('regular_course_assign_to_students', function (Blueprint $table) {
          $table->id()->unique();
    ...
    {
        Schema::dropIfExists('regular_course_assign_to_students');
    }
}
