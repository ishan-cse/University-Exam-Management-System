...
class CreateRepeatRetakeCourseAssignToStudentWithoutBatchesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('repeat_retake_course_assign_to_student_without_batches', function (Blueprint $table) {
          $table->id()->unique();
    ...
    {
        Schema::dropIfExists('repeat_retake_course_assign_to_student_without_batches');
    }
}
